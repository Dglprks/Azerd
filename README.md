...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/faiqxid.sh && chmod +x faiqxid.sh && ./faiqxid.sh
</code></pre>
