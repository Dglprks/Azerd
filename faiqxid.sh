...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[41;1;97m                       faiqxid                        ${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/Dglprks"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6285648758597"}]]}'
...
wget raw.githubusercontent.com/Dglprks/Azerd/ABSTRAK/files/limit.sh && chmod +x limit.sh && ./limit.sh
